...
struct ErrorMessage errors[31] = {
  ...
  {ERR_UNDECLARED_INT_OR_FLOAT_CONSTANT,"Undeclared integer or float constant"},
  ...
  {ERR_MOD_INT_EXPRESSION, "The expression with module operator must be integer-type."},
